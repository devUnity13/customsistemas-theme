    ...
    <section class="ctt-canais">
        <div class="ctt-container">
            <div class="ctt-canais-grid">
                ...
                <!-- WhatsApp -->
                <a href="https://wa.me/552133999999" target="_blank" rel="noopener"
                    class="ctt-canal-card ctt-canal-whatsapp">
                    ...
                    <div class="ctt-canal-content">
                        ...
                        <p><?php esc_html_e('Atendimento rápido pelo WhatsApp. Segunda a sexta, das 8h às 18h.', 'custom-sistemas'); ?>
                        </p>
                    </div>
                ...
                <a href="tel:08004005200" class="ctt-canal-card ctt-canal-telefone">
                    ...
                    <div class="ctt-canal-content">
                        ...
                        <p><?php esc_html_e('Chamada gratuita de qualquer telefone. Segunda a sexta, das 8h às 18h.', 'custom-sistemas'); ?>
                        </p>
                    </div>
                    <div class="ctt-canal-arrow">
                        <i class="bi bi-arrow-up-right"></i>
                ...
                <a href="mailto:contato@customsistemas.com.br" class="ctt-canal-card ctt-canal-email">
                    ...
                    <div class="ctt-canal-content">
                        ...
                        <p><?php esc_html_e('Envie sua mensagem. Respondemos em até 1 dia útil.', 'custom-sistemas'); ?>
                        </p>
                    </div>
                    <div class="ctt-canal-arrow">
                        <i class="bi bi-arrow-up-right"></i>
    ...
    <section class="ctt-departamentos">
        <div class="ctt-container">
            ...
            <div class="ctt-section-head">
                ...
                <p><?php esc_html_e('Direcione seu contato para o setor certo e tenha uma resposta mais rápida e precisa.', 'custom-sistemas'); ?>
                </p>
            </div>
                ...
                <?php foreach ($departamentos as $dept): ?>
                    <div class="ctt-dept-card <?php echo esc_attr($dept['cor']); ?>">
                        ...
                        <div class="ctt-dept-contatos">
                            ...
                            <a href="tel:<?php echo esc_attr(preg_replace('/[^0-9]/', '', $dept['tel'])); ?>"
                                class="ctt-dept-link">
        ...
        <div class="ctt-container">
            <div class="ctt-loc-layout">
                ...
                <div class="ctt-loc-info">
                    ...
                    <p><?php esc_html_e('Visite-nos pessoalmente ou envie correspondências para nossa sede no Rio de Janeiro.', 'custom-sistemas'); ?>
                    </p>
                    ...
                    <div class="ctt-loc-dados">
                        <div class="ctt-loc-item">
                            ...
                            <div>
                                ...
                                <span>Av. das Américas, 3434 — Sala 901<br>Barra da Tijuca — Rio de Janeiro, RJ<br>CEP:
                                    22640-102</span>
                            </div>
                        </div>
                        ...
                        <div class="ctt-loc-item">
                            ...
                            <div>
                                ...
                                <span>
                                    <?php esc_html_e('Geral:', 'custom-sistemas'); ?> <a href="tel:02133999999">(21)
                                        3399-9999</a><br>
                                    <?php esc_html_e('Suporte:', 'custom-sistemas'); ?> <a
                                        href="tel:08004005200">0800-400-5200</a>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="ctt-loc-item">
                            ...
                            <div>
                                ...
                                <span><a
                                        href="mailto:contato@customsistemas.com.br">contato@customsistemas.com.br</a></span>
                            </div>
                        </div>
                    </div>
    ...
    <section class="ctt-cta-final">
        ...
        <div class="ctt-container">
            <div class="ctt-cta-inner">
                ...
                <h2><?php esc_html_e('Ainda tem dúvidas?', 'custom-sistemas'); ?>
                    <em><?php esc_html_e('Chame pelo WhatsApp.', 'custom-sistemas'); ?></em>
                </h2>
                <p><?php esc_html_e('Nossa equipe responde em minutos. É rápido, direto e sem burocracia.', 'custom-sistemas'); ?>
                </p>
